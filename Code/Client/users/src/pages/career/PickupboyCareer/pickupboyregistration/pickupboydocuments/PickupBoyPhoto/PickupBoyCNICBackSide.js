...
import { chooseCnicBack } from '../../../../../../redux/containers/pickupboyreg/reducer';
import { useDispatch } from 'react-redux'; 
export default function PickupBoyCNICBackSide() {
    ...
    const handleUploadPhoto = () => {
        dispatch(chooseCnicBack(imageUrl));
        localStorage.setItem('pickupboy_cnic_back', JSON.stringify({ imageUrl }));

         // Show SweetAlert2 confirmation
         Swal.fire({
            icon: 'success',
            title: 'File Uploaded',
            text: 'Your CNIC Back side has been uploaded successfully.',
        });

        // Navigate to driver application form
        navigate('/pickupboy-driving-license');
    };
    return (
        <>
            <div className={careerStyles.container}>
                <div className={careerStyles.subContainer}>
                    ...
                    <div className={careerStyles.application_container}>
                        <h2>Take a photo of your CNIC Back Side</h2>
